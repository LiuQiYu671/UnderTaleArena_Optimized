...
######CHARGE
execute if entity @s[tag=cd_ready] run data modify storage soul ActionList append value '{"translate":"acb.ch","color":"yellow","font":"actionbar","with":[[{"bold":false,"score":{"name":"@s","objective":"cddis"},"extra":[{"text":"%"}],"font":"minecraft:back.state"},{"bold":false,"color":"white","score":{"name":"@s","objective":"cddis"},"extra":[{"text":"%"}],"font":"minecraft:default"}]]}'
execute unless entity @s[tag=cd_ready] run data modify storage soul ActionList append value '{"translate":"acb.ch","color":"red","font":"actionbar","with":[[{"bold":false,"score":{"name":"@s","objective":"cddis"},"extra":[{"text":"%"}],"font":"minecraft:back.state"},{"bold":false,"color":"red","score":{"name":"@s","objective":"cddis"},"extra":[{"text":"%"}],"font":"minecraft:default"}]]}'
######WILL
