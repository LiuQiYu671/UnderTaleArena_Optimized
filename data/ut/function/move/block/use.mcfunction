...
attribute @s generic.knockback_resistance modifier add blockkbr 1.0 add_value
attribute @s generic.movement_speed modifier add blockslow -0.4 add_multiplied_total
