...
execute if score #dodgeAgain plt2 matches 0 at @s positioned ~ ~1.5 ~ facing entity @a[tag=dodge_player,limit=1] eyes positioned ^ ^ ^.75 run function ut:move/passive/sans/trigger/5